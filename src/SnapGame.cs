...
namespace CardGames
{
    public class SnapGame
    {
        public static void LoadResources()
        {
            ...
            SwinGame.LoadFontNamed("ScoreFont", "Chunkfive.otf", 24);
        }
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.RoyalBlue, "ScoreFont", 0, 20);
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.RoyalBlue, "ScoreFont", 0, 50);
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.RoyalBlue, "ScoreFont", 0, 80);
				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 521, 153);
			}
			else
			{
				SwinGame.DrawText ("No card played yet...", Color.RoyalBlue, "ScoreFont", 0, 20);
			}
